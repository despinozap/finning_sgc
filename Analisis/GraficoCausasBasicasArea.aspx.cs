...
{
    public partial class GraficoCausasBasicasArea : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ChartCausasBasicasInterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
            ChartCausasBasicasExterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
        }
        ...
        protected void btGenerar_Click(object sender, EventArgs e)
        {
            ...
            Chart chart_interno = ChartBuilder.getChartCausasBasicasAreaInterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);
            Chart chart_externo = ChartBuilder.getChartCausasBasicasAreaExterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);

            if ((chart_interno != null) && (chart_externo != null))
            {
                dumpChart(chart_interno, ChartCausasBasicasInterno);
                dumpChart(chart_externo, ChartCausasBasicasExterno);
            }
            else
            {
