<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GraficoCausasInmediatasArea.aspx.cs" Inherits="NCCSAN.Analisis.GraficoCausasInmediatas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server">
        <contenttemplate>
            ...
            <div align="center">
                <asp:Chart ID="ChartCausasInmediatasInterno" runat="server" Width="1024px" Height="400px" >
                </asp:Chart>
            </div>
            <br />
            <div align="center">
                <asp:Chart ID="ChartCausasInmediatasExterno" runat="server" Width="1024px" Height="400px" >
                </asp:Chart>
            </div>
        </contenttemplate>
    </asp:UpdatePanel>
