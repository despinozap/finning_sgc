...
{
    public partial class GraficoCausasInmediatas : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ChartCausasInmediatasInterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
            ChartCausasInmediatasExterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
        }
        ...
        protected void btGenerar_Click(object sender, EventArgs e)
        {
            ...
            Chart chart_interno = ChartBuilder.getChartCausasInmediatasAreaInterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);
            Chart chart_externo = ChartBuilder.getChartCausasInmediatasAreaExterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);
            
            if ((chart_interno != null) && (chart_externo != null))
            {
                dumpChart(chart_interno, ChartCausasInmediatasInterno);
                dumpChart(chart_externo, ChartCausasInmediatasExterno);
            }
            else
            {
        ...
        private string validateParameters()
        {
            ...
            {
                return "No se ha seleccionado el área";
            }
