<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GraficoClasificacionesArea.aspx.cs" Inherits="NCCSAN.Analisis.GraficoClasificacionesArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server">
        <contenttemplate>
            ...
            <div align="center">
                <asp:Chart ID="ChartClasificacionesInterno" runat="server" Width="1024px" Height="400px" >
                </asp:Chart>
            </div>
            <br />
            <div align="center">
                <asp:Chart ID="ChartClasificacionesExterno" runat="server" Width="1024px" Height="400px" >
                </asp:Chart>
            </div>
        </contenttemplate>
    </asp:UpdatePanel>
