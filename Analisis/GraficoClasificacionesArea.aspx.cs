...
{
    public partial class GraficoClasificacionesArea : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ChartClasificacionesInterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
            ChartClasificacionesExterno.BackColor = ColorTranslator.FromHtml("#EEEEEE");
        }
        ...
        protected void btGenerar_Click(object sender, EventArgs e)
        {
            ...
            Chart chart_interno = ChartBuilder.getChartClasificacionesAreaInterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);
            Chart chart_externo = ChartBuilder.getChartClasificacionesAreaExterno(id_centro, ddlArea.SelectedItem.Value, anio, mes);

            if ((chart_interno != null) && (chart_externo != null))
            {
                dumpChart(chart_interno, ChartClasificacionesInterno);
                dumpChart(chart_externo, ChartClasificacionesExterno);
            }
            else
            {
