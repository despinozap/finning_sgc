<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GraficoIRCAcumuladoAnualMes.aspx.cs" Inherits="NCCSAN.Graficos.IRCAcumuladoAnualMes" %>
            ...
            <asp:Panel ID="pnFiltro" runat="server">
                <table align="center" class="tableControls">
                    <tr>
                        ...
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label7" runat="server" Text="Periodo (meses)"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label11" runat="server" Text="a1"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label1" runat="server" Text="b1"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label8" runat="server" Text="a2"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label9" runat="server" Text="b2"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label10" runat="server" Text="a3"></asp:Label>
                        </td>
                        <td class="tdFirst" align="left">
                            <asp:Label ID="Label12" runat="server" Text="b3"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="tdLast" align="right">
                            <asp:DropDownList ID="ddlAnio" runat="server" Width="100px" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td class="tdLast"  align="left">
                            <asp:DropDownList ID="ddlMes" runat="server" Width="120px" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td class="tdLast"  align="left">
                            <asp:TextBox ID="txtPeriodo" runat="server" TextMode="Number" MaxLength="2">6</asp:TextBox>
                        </td>
                        <td class="tdLast"  align="right">
