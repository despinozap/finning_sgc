...
{
    public partial class IRCAcumuladoMensualArea : System.Web.UI.Page
    {
        ...
        protected void btGenerar_Click(object sender, EventArgs e)
        {
            ...
            Chart chart = ChartBuilder.getChartIRCAcumuladoMensualArea(id_centro, anio, mes, a1, a2, a3, b1, b2, b3);
            if (chart != null)
            {
