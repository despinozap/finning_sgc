<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GraficoTOP5InvolucradosMensual.aspx.cs" Inherits="NCCSAN.Analisis.GraficoTOP5InvolucradosMensual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server">
        <contenttemplate>
            ...
            <div align="center">
                <asp:Chart ID="ChartTOP5Involucrados" runat="server" Width="1024px" Height="400px" >
                </asp:Chart>
            </div>
        </contenttemplate>
    </asp:UpdatePanel>
