...
{
    public partial class GraficoTOP5InvolucradosMensual : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ChartTOP5Involucrados.BackColor = ColorTranslator.FromHtml("#EEEEEE");
        }
        ...
        protected void btGenerar_Click(object sender, EventArgs e)
        {
            ...
            string nombre_area = ddlArea.Text;


            Chart chart = ChartBuilder.getChartTOP5Involucrados(id_centro, anio, mes, nombre_area);
            if (chart != null)
            {
                dumpChart(chart, ChartTOP5Involucrados);
            }
            else
            {
