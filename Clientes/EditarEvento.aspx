<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditarEvento.aspx.cs" Inherits="NCCSAN.Clientes.EditarEvento" %>
                    ...
                    <tr>
                        ...
                        <td class="tdLast">
                            ...
                            <asp:SqlDataSource ID="SDSCentro" runat="server" ConnectionString="<%$ ConnectionStrings:NCCSANConnectionString %>"
                                SelectCommand="SELECT c.id, c.nombre FROM CentroCliente cc, Centro c WHERE (cc.nombre_cliente=@nombre_cliente) AND (cc.id_centro=c.id)">
                                <SelectParameters>
                                    <asp:SessionParameter Name="nombre_cliente" SessionField="nombre_cliente" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                        <td class="tdLast">
