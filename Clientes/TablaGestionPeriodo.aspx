<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TablaGestionPeriodo.aspx.cs" Inherits="NCCSAN.Clientes.TablaGestionPeriodoCliente" %>
                    ...
                    <tr>
                        ...
                        <td class="tdUnique" align="left">
                            ...
                            <asp:SqlDataSource ID="SDSCentro" runat="server" 
                                ...
                                SelectCommand="SELECT c.id, c.nombre FROM Centro c, CentroCliente cc WHERE (cc.nombre_cliente=@nombre_cliente) AND (cc.id_centro=c.id) AND (c.id&lt;&gt;@id_ext) AND (c.id&lt;&gt;@id_rsp)">
                                <SelectParameters>
