<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DetalleEvaluacion.aspx.cs" Inherits="NCCSAN.Investigaciones.DetalleEvaluacion" %>
        ...
        <ContentTemplate>
                ...
                <table class="tableControls" align="center">
                    ...
                    <tr>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label2" runat="server" Text="Responsable" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label4" runat="server" Text="Antiguedad Responsable (años)" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label31" runat="server" Text="Días de Investigación" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label33" runat="server" Text="Fecha de Inicio" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label34" runat="server" Text="Fecha de Cierre" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label35" runat="server" Text="Días en curso" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLast" align="center">
            ...
            <asp:Panel ID="pnEvaluacion" runat="server">
                <table align="center" class="tableControls">
                    ...
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label11" runat="server" Text="Tipo causa inmediata" 
                                Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique">
                            <asp:Label ID="lbDetalleEvaluacionTipoCausaInmediata" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                    ...
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label10" runat="server" Text="Tipo causa básica" 
                                Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique">
                            <asp:Label ID="lbDetalleEvaluacionTipoCausaBasica" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                    ...
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label15" runat="server" Text="Responsable del Evento" Font-Bold="True"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="Label6" runat="server" Text="Evaluado por" Font-Bold="True"></asp:Label>
                        </td>
                        <td colspan="4" class="tdUnique" align="left">
                            <asp:LinkButton ID="lbtDetalleEvaluacionDetalleEvaluador" runat="server" OnClick="lbtDetalleEvaluacionDetalleEvaluador_Click"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
