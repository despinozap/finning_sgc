<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetalleVerificacion.aspx.cs" Inherits="NCCSAN.PlanesAccion.DetalleVerificacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <br />
            <asp:Panel ID="pnVerificacion" runat="server">
                <table align="center" class="tableControls">
                    <tr>
                        <td colspan="2" class="tdTitle">
                            <h1>
                                Panel Verificación</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label1" runat="server" Text="¿Fue efectivo?" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique">
                            <asp:Label ID="lbDetalleVerificacionEfectivo" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                        ...
                        <td class="tdUnique">
                            <asp:Label ID="lbDetalleVerificacionObservacion" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" class="tdUnique" align="left">
                            <asp:LinkButton ID="lbtDetalleVerificacionDetalleVerificador" runat="server" OnClick="lbtDetalleVerificacionDetalleVerificador_Click"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                        ...
                        <td class="tdUnique">
                            <asp:Label ID="lbDetalleVerificacionFecha" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
