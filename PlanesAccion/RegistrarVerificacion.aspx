<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarVerificacion.aspx.cs" Inherits="NCCSAN.PlanesAccion.RegistrarVerificacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <br />
            <br />
            <asp:Panel ID="pnVerificarEvento" runat="server">
                <table align="center" style="width: 40%" class="tableControls">
                    <tr>
                    ...
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label20" runat="server" Text="Efectivo" Font-Bold="False"></asp:Label>
                            &nbsp;<asp:Label ID="Label3" runat="server" Text="*" ForeColor="Red" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:RadioButtonList ID="rblVerificacion" runat="server" RepeatDirection="Horizontal">
            ...
            <asp:Panel ID="Panel1" runat="server">
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton ID="ibVerificarEvento" runat="server" CssClass="submitPanelButton"
                                ImageUrl="~/Images/Button/save.png" OnClick="ibVerificarEvento_Click" />
                        </td>
                    </tr>
                </table>
            ...
            <!-- Panel Detalle Evento !-->
            <!-- Panel Confirmar Verificación-->
            <asp:HiddenField ID="hfConfirmVerificacion" runat="server" />
            <asp:ModalPopupExtender ID="hfConfirmVerificacion_ModalPopupExtender" runat="server"
                BackgroundCssClass="Popup_background" DynamicServicePath="" Enabled="True" TargetControlID="hfConfirmVerificacion"
                PopupControlID="pnConfirmVerificacion">
            </asp:ModalPopupExtender>
            <asp:UpdatePanel ID="upConfirmVerificacion" runat="server" style="width: 100%" UpdateMode="Conditional">
                <ContentTemplate>
                    <br />
                    <br />
                    <asp:Panel ID="pnConfirmVerificacion" runat="server" CssClass="Popup_frontground" HorizontalAlign="Center"
                        Width="100%">
                        <asp:Label ID="lbMessageConfirmVerificacion" runat="server" CssClass="messageBoxTitle"></asp:Label>
                        <br />
                        <br />
                        <table align="center">
                            <tr>
                                <td>
                                    <asp:Button ID="btConfirmVerificacionSi" runat="server" Text="Si" Width="70px" CssClass="submitButton"
                                        OnClick="btConfirmVerificacionSi_Click" />
                                </td>
                                <td>
                                    <asp:Button ID="btConfirmVerificacionNo" runat="server" Text="No" Width="70px" CssClass="submitButton"
                                        OnClick="btConfirmVerificacionNo_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <!-- Panel Confirmar Verificación !-->
            <!-- Panel Message Efectivo -->
            <asp:HiddenField ID="hfMessageEfectivo" runat="server" />
            <asp:ModalPopupExtender ID="hfMessageEfectivo_ModalPopupExtender" runat="server" BackgroundCssClass="Popup_background"
                DynamicServicePath="" Enabled="True" PopupControlID="upMessageEfectivo" TargetControlID="hfMessageEfectivo">
            </asp:ModalPopupExtender>
            <asp:UpdatePanel ID="upMessageEfectivo" runat="server" UpdateMode="Conditional" style="width: 100%">
                <ContentTemplate>
                    <br />
                    <br />
                    <asp:Panel ID="pnMessageEfectivo" runat="server" CssClass="Popup_frontground" HorizontalAlign="Center">
                        <asp:Label ID="lbMessageEfectivo" runat="server" CssClass="messageBoxTitle"></asp:Label>
                        <br />
                        <br />
                        <table align="center">
                            <tr>
                                <td>
                                    <asp:Button ID="btMessageEfectivoAceptar" runat="server" Text="Aceptar" Width="70px" CssClass="submitButton"
                                        OnClick="btMessageEfectivoAceptar_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <!-- Panel Message Efectivo !-->
            <!-- Panel Message No Efectivo -->
            <asp:HiddenField ID="hfMessageNoEfectivo" runat="server" />
            <asp:ModalPopupExtender ID="hfMessageNoEfectivo_ModalPopupExtender" runat="server" BackgroundCssClass="Popup_background"
                DynamicServicePath="" Enabled="True" PopupControlID="upMessageNoEfectivo" TargetControlID="hfMessageNoEfectivo">
            </asp:ModalPopupExtender>
            <asp:UpdatePanel ID="upMessageNoEfectivo" runat="server" UpdateMode="Conditional" style="width: 100%">
                <ContentTemplate>
                    <br />
                    <br />
                    <asp:Panel ID="pnMessageNoEfectivo" runat="server" CssClass="Popup_frontground" HorizontalAlign="Center">
                        <asp:Label ID="lbMessageNoEfectivo" runat="server" CssClass="messageBoxTitle"></asp:Label>
                        <br />
                        <br />
                        <table align="center">
                            <tr>
                                <td>
                                    <asp:Button ID="btMessageNoEfectivoSi" runat="server" Text="Si" Width="70px" CssClass="submitButton"
                                        OnClick="btMessageNoEfectivoSi_Click" />
                                </td>
								<td>
                                    <asp:Button ID="btMessageNoEfectivoNo" runat="server" Text="No" Width="70px" CssClass="submitButton"
                                        OnClick="btMessageNoEfectivoNo_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
