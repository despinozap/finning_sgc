<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DetalleAccionInmediata.aspx.cs" Inherits="NCCSAN.Registros.DetalleAccionInmediata" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="divTituloForm">
        <h1>
            Detalle de Acción Inmediata</h1>
    </div>
    ...
    <asp:UpdatePanel ID="uPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnCausas" runat="server">
                <table align="center" class="tableControls" width="60%">
                    <tr>
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label4" runat="server" Text="Origen de falla" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                            <asp:Label ID="lbOrigenFalla" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label3" runat="server" Text="Tipo causa inmediata" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                            <asp:Label ID="lbTipoCausaInmediata" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label12" runat="server" Text="Causa inmediata" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                            <asp:Label ID="lbCausaInmediata" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label13" runat="server" Text="Sub-causa inmediata" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbSubcausaInmediata" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label2" runat="server" Text="Tipo causa básica" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbTipoCausaBasica" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label14" runat="server" Text="Causa básica" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbCausaBasica" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label15" runat="server" Text="Sub-causa básica" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbSubcausaBasica" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label1" runat="server" Text="Responsable del Evento" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbNombreResponsableEvento" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            ...
            <asp:Panel ID="pnAccionInmediata" runat="server">
                <table align="center" class="tableControls" width="60%">
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label22" runat="server" Text="Acción inmediata" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                            <asp:Label ID="lbAccionInmediata" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label23" runat="server" Text="Fecha" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbFechaAccion" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label20" runat="server" Text="Efectividad" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="lbEfectividad" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label25" runat="server" Text="Observación" Font-Bold="True"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left">
                    ...
                    <tr>
                        <td class="tdFirst">
                            <asp:GridView ID="gvArchivosAccionInmediata" runat="server" AutoGenerateColumns="False"
                                HorizontalAlign="Center" Width="863px" OnRowCommand="gvArchivosAccionInmediata_RowCommand"
                            ...
                            <asp:UpdatePanel ID="upInvolucrados" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="gvInvolucrados" runat="server" AutoGenerateColumns="False" HorizontalAlign="Center"
                                        Width="690px" ShowHeaderWhenEmpty="True">
                                        <Columns>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="gvArchivosAccionInmediata" />
