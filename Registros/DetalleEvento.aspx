<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DetalleEvento.aspx.cs" Inherits="NCCSAN.Registros.DetalleEvento" %>
            ...
            <asp:Panel ID="pnDetalleEvento" runat="server" HorizontalAlign="Center" CssClass="Popup_frontground"
                ...
                <table class="tableControls" align="center">
                    ...
                    <tr>
                        ...
                        <td class="tdFirst" align="center">
                            <asp:Label ID="Label67" runat="server" Text="Agente corrector" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLast" align="center">
                        ...
                        <td class="tdLast" align="center">
                            <asp:Label ID="lbDetalleEventoAgenteCorrector" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdFirst" align="center">
                    ...
                    <tr>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="Label20" runat="server" Text="Documentos relacionados" Font-Bold="True"></asp:Label>
                        </td>
                        <td colspan="4" class="tdUnique" align="left">
                            <asp:GridView ID="gvDocumentosRelacionados" runat="server" AutoGenerateColumns="False"
                                OnRowCommand="gvDocumentosRelacionados_RowCommand" 
                                ShowHeaderWhenEmpty="True">
                                <Columns>
                                    <asp:TemplateField HeaderText="Accion Inmediata" HeaderStyle-BackColor="#666666"
                                        HeaderStyle-ForeColor="#FFFFFF">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibDetalleAccionInmediata" runat="server" CommandName="DetalleAccionInmediata"
                                                ImageUrl="~/Images/Icon/search.png" />
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#666666" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Evaluación" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="#FFFFFF">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibDetalleEvaluacion" runat="server" CommandName="DetalleEvaluacion"
                                                ImageUrl="~/Images/Icon/search.png" />
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#666666" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Plan de Acción" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="#FFFFFF">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibDetallePlanAccion" runat="server" CommandName="DetallePlanAccion"
                                                ImageUrl="~/Images/Icon/search.png" />
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#666666" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Verificación" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="#FFFFFF">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibDetalleVerificacion" runat="server" CommandName="DetalleVerificacion"
                                                ImageUrl="~/Images/Icon/search.png" />
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#666666" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                ...
                                <EmptyDataTemplate>
                                    ...
                                    <asp:Label ID="lbEmptyList" runat="server" Text="  No existe documentación relacionada"
                ...
                <asp:Panel ID="pnInvolucrados" runat="server" Visible="False">
                    <br />
                    <br />
