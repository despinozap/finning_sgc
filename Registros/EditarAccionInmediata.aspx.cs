...
{
    public partial class EditarAccionInmediata : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["CodigoEventoSeleccionado"] != null)
                {
                    ...
                    if (codigo != null)
                    {
                        AccionInmediata accion_inmediata = LogicController.getAccionInmediata(codigo);
                        if (accion_inmediata != null)
                        {
                            Session["AccionInmediata"] = accion_inmediata;
                            if (!loadAccionInmediata())
                            {
                                string msg = "Error al cargar información de la Acción Inmediata";
                                Response.Redirect("~/Error.aspx?msg=" + HttpUtility.UrlEncode(msg), true);
                            }
                        }
                        else
                        {
                            string msg = "Error al recuperar la Acción Inmediata";
                            Response.Redirect("~/Error.aspx?msg=" + HttpUtility.UrlEncode(msg), true);
                        }
                    }
                    else
        ...
        private AccionInmediata getAccionInmediata()
        {
            if (Session["AccionInmediata"] != null)
            {
                AccionInmediata accion_inmediata = (AccionInmediata)Session["AccionInmediata"];
        ...
        private bool loadAccionInmediata()
        {
            AccionInmediata accion_inmediata = getAccionInmediata();
            if (accion_inmediata == null)
            {
                return false;
            }

            hfCodigoEvento.Value = accion_inmediata.getCodigoEvento();

            if (!loadResponsablesEvento(accion_inmediata.getCodigoEvento()))
            {
                return false;
            }


            PersonaInfo responsable_evento = LogicController.getResponsableEvento(accion_inmediata.getCodigoEvento());
            ...
            txtAccionInmediata.Text = accion_inmediata.getAccionInmediata();
            txtFechaAccionInmediata.Text = accion_inmediata.getFechaAccion();
            rblEfectividad.SelectedValue = accion_inmediata.getEfectividad();
            if (accion_inmediata.getObservacion() != null)
            {
                txtObservacion.Text = accion_inmediata.getObservacion();
            }

            List<Archivo> listArchivos = LogicController.getArchivosAccionInmediata(accion_inmediata.getCodigoEvento());
            ...
            List<PersonaInfo> listInvolucrados = LogicController.getListInvolucradosEvento(accion_inmediata.getCodigoEvento());
        ...
        protected void ddlOrigenFalla_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlOrigenFalla.Text = accion_inmediata.getNombreOrigen();
        ...
        protected void ddlTipoCausaInmediata_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlTipoCausaInmediata.Text = accion_inmediata.getTipoCausaInmediata();
                    SDSCausaInmediata.DataBind();
                }
            }
        }
        ...
        protected void ddlCausaInmediata_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlCausaInmediata.Text = accion_inmediata.getNombreCausaInmediata();
                    SDSSubcausaInmediata.DataBind();
                }
            }
        }
        ...
        protected void ddlSubcausaInmediata_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlSubcausaInmediata.Text = accion_inmediata.getNombreSubcausaInmediata();
                }
            }
        }
        ...
        protected void ddlTipoCausaBasica_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlTipoCausaBasica.Text = accion_inmediata.getTipoCausaBasica();
                    SDSCausaBasica.DataBind();
                }
            }
        }
        ...
        protected void ddlCausaBasica_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlCausaBasica.Text = accion_inmediata.getNombreCausaBasica();
                    SDSSubcausaBasica.DataBind();
                }
            }
        }
        ...
        protected void ddlSubcausaBasica_DataBound(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (accion_inmediata != null)
                {
                    ddlSubcausaBasica.Text = accion_inmediata.getNombreSubcausaBasica();
                }
            }
        }
        ...
        protected void ibRegistrarAccionInmediata_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (errors.Count == 0)
            {
                ...
                {
                    lbMessageConfirmAccionInmediata.Text = "Se va a editar la Acción Inmediata como <b>Efectiva</b>. ¿Desea continuar?";
                }
                else
                {
                    lbMessageConfirmAccionInmediata.Text = "Se va a editar la Acción Inmediata como <b>No efectiva</b>. ¿Desea continuar?";
                }
        ...
        private string actualizarAccionInmediata()
        {
            AccionInmediata accion_inmediata = getAccionInmediata();
            if (accion_inmediata == null)
            {
                return "Error al recuperar la Acción Inmediata";
            }
            ...
            string registrado = LogicController.updateAccionInmediata
                                                                    (
                                                                        accion_inmediata.getCodigoEvento(),
                                                                        origen,
                                                                        causa_inmediata,
                                                                        subcausa_inmediata,
                                                                        causa_basica,
            ...
            if (registrado == null)
            {
                Session.Remove("AccionInmediata");

                return null;
            }
            else
            {
                return "Error al actualizar la Acción Inmediata: " + registrado;
            }
        }
        ...
        {
            Response.Redirect("~/Registros/ListarAccionesInmediatasRegistradas.aspx", true);
        }
        ...
        {
            string status = actualizarAccionInmediata();
            if (status == null)
            {
                Session.Remove("AccionInmediata");
                Session.Remove("p");
                ...
                lbMessage.Text = "La Acción Inmediata se actualizó satisfactoriamente para el Evento con código <b>" + hfCodigoEvento.Value + "</b>";
