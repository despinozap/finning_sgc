<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditarEvento.aspx.cs" Inherits="NCCSAN.Registros.EditarEvento" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnDetalleEvento" runat="server" HorizontalAlign="Center">
                <table class="tableControls" align="center">
                    ...
                    <tr>
                        <td class="tdLast">
                            <asp:TextBox ID="txtCodigo" runat="server" Text='<%# Eval("codigo") %>' ReadOnly="True"
                    ...
                    <tr>
                        ...
                        <td class="tdFirst">
                            ...
                            &nbsp;<asp:Label ID="lbAsteriskSerieEquipo" runat="server" Text="*" ForeColor="Red" Font-Bold="True" ></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLast">
                        ...
                        <td class="tdLast">
                            <asp:DropDownList ID="ddlModelo" runat="server" DataSourceID="SDSModelo"
                                DataTextField="modelo_equipo" DataValueField="modelo_equipo" OnDataBound="ddlModelo_DataBound"
                    ...
                    <tr>
                        ...
                        <td class="tdFirst">
                            <asp:Label ID="Label16" runat="server" Text="Agente corrector (Sólo CSAR)"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLast">
                        ...
                        <td class="tdLast">
                            <asp:TextBox ID="txtAgenteCorrector" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdFirst">
                            <asp:Label ID="Label17" runat="server" Text="Área"></asp:Label>
                            &nbsp;<asp:Label ID="Label35" runat="server" Text="*" ForeColor="Red" Font-Bold="True" ></asp:Label>
                        </td>
                        <td class="tdFirst">
                            <asp:Label ID="Label18" runat="server" Text="Sub-área"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td class="tdLast">
                            <asp:DropDownList ID="ddlSubarea" runat="server" DataSourceID="SDSSubarea" DataTextField="nombre_subarea"
                                DataValueField="nombre_subarea" OnDataBound="ddlSubarea_DataBound" Width="250px">
                            </asp:DropDownList>
                        ...
                        <td class="tdLast">
                            ...
                            <asp:SqlDataSource ID="SDSSubclasificacion" runat="server" ConnectionString="<%$ ConnectionStrings:NCCSANConnectionString %>"
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlClasificacion" Name="nombre_clasificacion" 
                    ...
                    <tr>
                        <td class="tdFirst">
                            <asp:Label ID="Label21" runat="server" Text="Probabilidad"></asp:Label>
                            &nbsp;<asp:Label ID="Label39" runat="server" Text="*" ForeColor="Red" Font-Bold="True" ></asp:Label>
                        </td>
                        <td class="tdFirst">
                            <asp:Label ID="Label22" runat="server" Text="Consecuencia"></asp:Label>
                            &nbsp;<asp:Label ID="Label40" runat="server" Text="*" ForeColor="Red" Font-Bold="True" ></asp:Label>
                        </td>
                        <td class="tdFirst">
                            <asp:Label ID="Label23" runat="server" Text="IRC"></asp:Label>
                        </td>
                        <td class="tdFirst">
                            <asp:Label ID="Label24" runat="server" Text="Criticidad"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLast">
                        ...
                        <td class="tdLast">
                            <asp:TextBox ID="txtIRC" runat="server" ReadOnly="True" Enabled="false"></asp:TextBox>
                        </td>
                        <td class="tdLast">
                            <asp:TextBox ID="txtCriticidad" runat="server" ReadOnly="True" Enabled="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <asp:UpdatePanel ID="upMatrizConsecuencia" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnMatrizConsecuencia" runat="server" HorizontalAlign="Center" CssClass="Popup_frontground">
                        ...
                        <br />
                        <asp:Button ID="btCerrarMatrizConsecuencia" runat="server" Text="Cerrar" OnClick="btCerrarMatrizConsecuencia_Click" CssClass="submitButton" />
                    </asp:Panel>
                </ContentTemplate>
            </asp:UpdatePanel>
            <!-- Panel Matriz Consecuencia !-->
