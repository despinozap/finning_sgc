    ...
    public partial class ListarEventos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ddlCreadorEvento.Items.Clear();
                ddlCreadorEvento.Items.Add(new ListItem("[Todos]", ""));
        ...
        private bool loadCreadoresEventos()
        {
            ...
            List<PersonaInfo> listCreadoresEventos = LogicController.getListCreadoresEventos(id_centro);
            if (listCreadoresEventos == null)
            {
                return false;
            }
            ...
            ddlCreadorEvento.Items.Clear();
            foreach (PersonaInfo creador in listCreadoresEventos)
            {
                ddlCreadorEvento.Items.Add(new ListItem(creador.getNombre(), creador.getRut()));
            }

            ddlCreadorEvento.Items.Insert(0, new ListItem("[Todos]", ""));
        ...
        private List<ListItem> getListItemsEstados()
        {
            ...
            listItemsEstados.Add(new ListItem("Revisión pendiente", "Revisión pendiente"));
        ...
        protected void ibExportToExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            dr = dtFiltro.NewRow();
            dr[0] = "Fuente";
            dr[1] = ddlFuente.SelectedItem.Text;
            dtFiltro.Rows.Add(dr);
        ...
        protected void gvEventos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("DetalleEvento"))
            {
                ...
                if ((index >= 0) && (index < gvEventos.Rows.Count))
                {
                    ...
                    Response.Redirect("~/Registros/DetalleEvento.aspx");
                }
            }
            else if (e.CommandName.Equals("EditarEvento"))
            {
                ...
                if ((index >= 0) && (index < gvEventos.Rows.Count))
                {
                    ...
                    Response.Redirect("~/Registros/EditarEvento.aspx");
                }
            }
        ...
        protected void chbCreadorEvento_CheckedChanged(object sender, EventArgs e)
        {
            if (chbCreadorEvento.Checked)
            {
                ddlCreadorEvento.Enabled = true;
                if (!loadCreadoresEventos())
                {
                    showMessageError("No se puede cargar la lista de creadores de Eventos");

                    ddlCreadorEvento.Items.Clear();
                    ddlCreadorEvento.Items.Add(new ListItem("[Todos]", ""));
                    ddlCreadorEvento.Enabled = false;
                }
            }
            else
            {
        ...
        {
            ddlFuente.Items.Insert(0, new ListItem("[Todas]", ""));
        }
