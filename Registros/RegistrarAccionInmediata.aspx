<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistrarAccionInmediata.aspx.cs" Inherits="NCCSAN.Registros.RegistroAccionInmediata"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="uPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <br />
            <asp:Panel ID="pnCausasEvaluacion" runat="server">
                <table align="center" class="tableControls">
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label32" runat="server" Text="Origen de falla"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label29" runat="server" Text="Tipo causa inmediata"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label12" runat="server" Text="Causa inmediata"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
                    ...
                    <tr>
                        <td class="tdUnique">
                            <asp:Label ID="Label13" runat="server" Text="Sub-causa inmediata"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="Label24" runat="server" Text="Tipo causa básica"></asp:Label>
                        </td>
                        <td class="tdUnique">
                    ...
                    <tr>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="Label14" runat="server" Text="Causa básica"></asp:Label>
                        </td>
                        <td class="tdUnique">
                    ...
                    <tr>
                        <td class="tdUnique" align="left">
                            <asp:Label ID="Label15" runat="server" Text="Sub-causa básica"></asp:Label>
                        </td>
                        <td class="tdUnique">
                    ...
                    <tr>
                        <td class="tdUnique" width="30%">
                            <asp:Label ID="Label2" runat="server" Text="Responsable"></asp:Label>
                        </td>
                        <td class="tdUnique" align="left" width="70%">
            ...
            <asp:Panel ID="pnAccionInmediata" runat="server">
                ...
                <br />
                <br />
                <asp:Panel ID="pnInvolucradosEvaluacion" runat="server">
                    <table align="center" class="tableControls">
                        <tr>
                            <td colspan="2" class="tdTitle">
                                <h1>
                        ...
                        <tr>
                            <td class="tdFirst">
                                <asp:UpdatePanel ID="upInvolucradosEvaluacion" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="gvInvolucradosEvaluacion" runat="server" AutoGenerateColumns="False"
                                            HorizontalAlign="Center" Width="690px" ShowHeaderWhenEmpty="True">
                                            <Columns>
